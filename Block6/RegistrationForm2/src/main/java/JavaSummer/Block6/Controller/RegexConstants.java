...
public interface RegexConstants {
  ...
  String NICKNAME_PATTERN = "pattern.nickname";
  String COMMENT_PATTERN = "pattern.comment";
  String HOME_PHONE_PATTERN = "pattern.home.phone";
  String MOBILE_PHONE_PATTERN = "pattern.mobile.phone";
  ...
  String DATE_PATTERN = "pattern.date";
}
